...
public class T6p2e3 {
    ...
    public static void main(String[] args) {
        ...
        //Empresa + empleados
        listaEmpresas[2] = new Empresa("Ford", getListaClientes2 ());
        //listaEmpresas[2].setEmpleado(lista.add(new Empleado("e11",21,100200)));
        //listaEmpresas[2].setEmpleado(getEmpleado());
        añadirEmpleados(listaEmpresas[2]);
        buscarDirectivoConMasSubordinados(listaEmpresas);
    }
    private static void añadirEmpleados(Empresa empresa) {
    ...
    public static ArrayList<Cliente> getListaClientes2(){
        ArrayList<Cliente> lista = new ArrayList();
        // Clientes con nombre, edad y teléfono
        lista.add(new Cliente("c11",21,"1111"));
        lista.add(new Cliente("c21",31,"4111"));
        lista.add(new Cliente("c31",41,"6111"));
        return lista;
    }
